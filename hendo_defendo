...
class Game():
    ...
    # Labels not Buttons cos they look nicer and it's really
    ...
    def create_info_widgets(self):
        ...
        loss_label = Label(self.info_frame, text='You lose!', bg = 'white', fg='white')
        loss_label.pack(side='top', fill = Y, expand=True)

        spacer = Label(self.info_frame, text='', bg = 'white')
        spacer.pack(side='top', fill = Y, expand=True)

        hit_label = Label(self.info_frame, text='Hits:', bg = 'white', fg='black')
        hit_label.pack(side='top', fill = Y, expand=True)

        hit_count = Label(self.info_frame, text='0', bg = 'white', fg='black')
        hit_count.pack(side='top', fill = Y, expand=True)

        spacer = Label(self.info_frame, text='', bg = 'white')
        spacer.pack(side='top', fill = Y, expand=True)

        miss_label = Label(self.info_frame, text='Misses:', bg = 'white',fg='black')
        miss_label.pack(side='top', fill = Y, expand=True)

        miss_count = Label(self.info_frame, text='0', bg = 'white', fg='black')
